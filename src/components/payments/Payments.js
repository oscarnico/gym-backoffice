    ...
    <div className="divPayments">
      ...
      {selectedCustomer && (
        <>
          ...
          <select className="combo" value={selectedService} onChange={handleServiceChange}>
          ...
          <button className="btnAsing" onClick={handleSubmit}>Assign Service <i className="fa-solid fa-money-check-dollar"></i> </button>
        </>
      )}
    </div>
  );
